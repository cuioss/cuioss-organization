...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/maven-build.yml@<sha>
    secrets: inherit
----
...
|`release.generate-release-notes` |boolean |`false` |Append GitHub auto-generated changelog to release notes 
|===
