...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
----
...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
    secrets:
...
jobs:
  integration-tests:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
    with:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0 # <version>
    permissions:
      contents: write
      pull-requests: write
----
...
jobs:
  review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pr-agent-review.yml@daae5e2ca7930267ceeee92cbb35041687de6544 # v0.26.0
    secrets:
