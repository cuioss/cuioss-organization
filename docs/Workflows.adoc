...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
----
...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
    secrets:
...
jobs:
  integration-tests:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
    with:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@05fe424dc32f31daa2fc369fb52ca360d84a62f4 # v0.11.1 # <version>
    permissions:
      contents: write
      pull-requests: write
----
