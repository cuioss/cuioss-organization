...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@f3b0586c485fa1f4ea8e004bd56f27f0a7d280df # v0.23.0
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@f3b0586c485fa1f4ea8e004bd56f27f0a7d280df # v0.23.0
    secrets:
...
jobs:
  integration-tests:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@f3b0586c485fa1f4ea8e004bd56f27f0a7d280df # v0.23.0
    with:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@f3b0586c485fa1f4ea8e004bd56f27f0a7d280df # v0.23.0
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@f3b0586c485fa1f4ea8e004bd56f27f0a7d280df # v0.23.0
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@f3b0586c485fa1f4ea8e004bd56f27f0a7d280df # v0.23.0
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@f3b0586c485fa1f4ea8e004bd56f27f0a7d280df # v0.23.0 # <version>
    permissions:
      contents: write
      pull-requests: write
----
