...
jobs:
  build:
    ...
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@c73577f3dd9d8a567fe8f79fbfe95e4c5d5fd259 # v0.2.1
    secrets:
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@c73577f3dd9d8a567fe8f79fbfe95e4c5d5fd259 # v0.2.1
    secrets:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@c73577f3dd9d8a567fe8f79fbfe95e4c5d5fd259 # v0.2.1
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@c73577f3dd9d8a567fe8f79fbfe95e4c5d5fd259 # v0.2.1
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    # Run on push, OR on pull_request only if from a fork
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@c73577f3dd9d8a567fe8f79fbfe95e4c5d5fd259 # v0.2.1
----
