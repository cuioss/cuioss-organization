...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@7f1bac840abf425e30dcc8b01b45fdf9b74889bd # v0.28.0
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@7f1bac840abf425e30dcc8b01b45fdf9b74889bd # v0.28.0
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@7f1bac840abf425e30dcc8b01b45fdf9b74889bd # v0.28.0
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@7f1bac840abf425e30dcc8b01b45fdf9b74889bd # v0.28.0 # <version>
    permissions:
      contents: write
      pull-requests: write
----
