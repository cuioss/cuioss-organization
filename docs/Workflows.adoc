...
jobs:
  build:
    ...
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@ffe58c94e5025487cd4c6cab741289d722675378 # v0.2.2
    secrets:
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@ffe58c94e5025487cd4c6cab741289d722675378 # v0.2.2
    secrets:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@ffe58c94e5025487cd4c6cab741289d722675378 # v0.2.2
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@ffe58c94e5025487cd4c6cab741289d722675378 # v0.2.2
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    # Run on push, OR on pull_request only if from a fork
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@ffe58c94e5025487cd4c6cab741289d722675378 # v0.2.2
----
