...
jobs:
  build:
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
    secrets:
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
    secrets:
...
jobs:
  integration-tests:
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
    with:
      test-type: java-it
...
|string
|``
|Project-relative path to report folder for deployment
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    ...
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
----
...
jobs:
  build:
    # Run on push, OR on pull_request only if from a fork
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
    secrets:
      SONAR_TOKEN: ${{ secrets.SONAR_TOKEN }}
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@2b65864a7014d3e0b24af7d787ffcfc3f0dcc448 # v0.3.5
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
