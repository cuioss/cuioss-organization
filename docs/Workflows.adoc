...
jobs:
  build:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
    secrets:
...
jobs:
  integration-tests:
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
    with:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    ...
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
----
...
jobs:
  build:
    # Run on push, OR on pull_request only if from a fork
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
    secrets:
      SONAR_TOKEN: ${{ secrets.SONAR_TOKEN }}
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@fbb87b2940f43cd3c6907c194dbbd437b2a78aa4 # v0.5.0 # <version>
    permissions:
      contents: write
      pull-requests: write
----
