...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
----
...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
    secrets:
...
jobs:
  integration-tests:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
    with:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@37d7d02d2c4615e514cf7b6e4a060806d9611663 # v0.8.0 # <version>
    permissions:
      contents: write
      pull-requests: write
----
