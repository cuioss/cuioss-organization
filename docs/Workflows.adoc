...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
----
...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
    secrets:
...
jobs:
  integration-tests:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
    with:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@83b3ab36e40dedbeda0ee74ac71876183b70b649 # v0.15.2 # <version>
    permissions:
      contents: write
      pull-requests: write
----
