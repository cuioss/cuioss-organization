...
jobs:
  build:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3
    secrets:
...
jobs:
  integration-tests:
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-integration-tests.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3
    with:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3
    permissions:
...
jobs:
  verify:
    ...
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3
----
...
jobs:
  build:
    # Run on push, OR on pull_request only if from a fork
    if: github.event_name != 'pull_request' || github.event.pull_request.head.repo.full_name != github.event.pull_request.base.repo.full_name
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3
    secrets:
      SONAR_TOKEN: ${{ secrets.SONAR_TOKEN }}
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@a2ee815b81b2ea8eb6262c60877754b998ef065f # v0.6.3 # <version>
    permissions:
      contents: write
      pull-requests: write
----
