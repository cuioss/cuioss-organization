...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-build.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0
----
...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/reusable-maven-release.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0
    secrets:
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-scorecards.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0
    permissions:
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependency-review.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0
    permissions:
      contents: read
      pull-requests: write
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@146d2d377eea7ffae0c73f06df8087a0948a534a # v0.22.0 # <version>
    permissions:
      contents: write
      pull-requests: write
----
