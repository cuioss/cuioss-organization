...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-build.yml@ab447694b019d30edc56f2ff7c5100ba731ca590 # v0.15.3
----
...
jobs:
  verify:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-pyprojectx-verify.yml@ab447694b019d30edc56f2ff7c5100ba731ca590 # v0.15.3
----
...
jobs:
  release:
    permissions:
      ...
      id-token: write
    if: github.event.pull_request.merged == true || github.event_name == 'workflow_dispatch'
    uses: cuioss/cuioss-organization/.github/workflows/reusable-npm-publish.yml@ab447694b019d30edc56f2ff7c5100ba731ca590 # v0.15.3
    secrets:
      RELEASE_APP_ID: ${{ secrets.RELEASE_APP_ID }}
      RELEASE_APP_PRIVATE_KEY: ${{ secrets.RELEASE_APP_PRIVATE_KEY }}
----
...
jobs:
  auto-merge:
    uses: cuioss/cuioss-organization/.github/workflows/reusable-dependabot-auto-merge.yml@ab447694b019d30edc56f2ff7c5100ba731ca590 # v0.15.3 # <version>
    permissions:
      contents: write
      pull-requests: write
----
