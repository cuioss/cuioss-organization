...
1. Edit `config.yml` - add repositories, adjust settings
2. Run the script:
+
[source,bash]
----
./setup-repo-settings.sh
----
...
----
features:
  has_wiki: true        # Enable wiki for specific need

security:
  secret_scanning: false  # Disable if not needed
----
