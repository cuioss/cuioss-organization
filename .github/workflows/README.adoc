...
jobs:
  build:
    uses: cuioss/cuioss-organization/.github/workflows/maven-build.yml@ab9c1504e30dcc5928d86d9e0147bc1ceb35383c # v0.1.0
    secrets: inherit
----
...
jobs:
  release:
    ...
    uses: cuioss/cuioss-organization/.github/workflows/maven-release.yml@ab9c1504e30dcc5928d86d9e0147bc1ceb35383c # v0.1.0
    secrets: inherit
----
...
jobs:
  analysis:
    uses: cuioss/cuioss-organization/.github/workflows/scorecards.yml@ab9c1504e30dcc5928d86d9e0147bc1ceb35383c # v0.1.0
    secrets: inherit
----
...
jobs:
  dependency-review:
    uses: cuioss/cuioss-organization/.github/workflows/dependency-review.yml@ab9c1504e30dcc5928d86d9e0147bc1ceb35383c # v0.1.0
    secrets: inherit
----
